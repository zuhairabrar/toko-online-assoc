...
<title>Administrator BitCom Online Jember</title>
...
<div id="bg-login">
<div id="judul"><img src="<?php echo base_url(); ?>asset/images/logo-login2.png" /></div>
...
<div id="judul"><br />Administrator BitCom Online Jember - <?php echo date('Y'); ?></div>
</div>
</form>
</body>
</html>
