...
<table width="100%">
	...
	<?php
		if($e['tipe_produk']=="pckomputer"){
	?>
		<option value="pckomputer" selected="selected">PC Komputer</option>
		<option value="notebook">Notebook/Laptop</option>
		<option value="projector">Projector</option>
		<option value="networking">Networking</option>
		<option value="accesories">Accesories</option>
	<?php
		}elseif($e['tipe_produk']=="notebook"){
	?>
		<option value="pckomputer">PC Komputer</option>
		<option value="notebook" selected="selected">Notebook/Laptop</option>
		<option value="projector">Projector</option>
		<option value="networking">Networking</option>
		<option value="accesories">Accesories</option>
	<?php
		}elseif($e['tipe_produk']=="projector"){
	?>
		<option value="pckomputer">PC Komputer</option>
		<option value="notebook">Notebook/Laptop</option>
		<option value="projector" selected="selected">Projector</option>
		<option value="networking">Networking</option>
		<option value="accesories">Accesories</option>
	<?php
		}elseif($e['tipe_produk']=="networking"){
	?>
		<option value="pckomputer">PC Komputer</option>
		<option value="notebook">Notebook/Laptop</option>
		<option value="projector">Projector</option>
		...
		<option value="accesories">Accesories</option>
	<?php
		}elseif($e['tipe_produk']=="accesories"){
	?>
		<option value="pckomputer">PC Komputer</option>
		<option value="notebook">Notebook/Laptop</option>
		<option value="projector">Projector</option>
		<option value="networking">Networking</option>
		<option value="accesories" selected="selected">Accesories</option>
	<?php
		}
	?>
	</select>
