...
<div id="menu-kiri">
<ul>
<a href="<?php echo $this->config->item('site_url');?>web" title="Beranda - BitCom Online Jember"><li><img src="<?php echo base_url(); ?>asset/images/icon-home.png" class="menu-img" border="0" />Beranda</li></a>

<a href="<?php echo $this->config->item('site_url');?>profil_sandal_online" title="Profil Kami | BitCom Online Jember"><li><img src="<?php echo base_url(); ?>asset/images/icon-about.png" class="menu-img" border="0" />Tentang Kami</li></a>

<a href="<?php echo $this->config->item('site_url');?>cara_belanja" title="Cara Belanja | BitCom Online Jember"><li><img src="<?php echo base_url(); ?>asset/images/icon-how-to.png" class="menu-img" border="0" />Cara Belanja</li></a>

<a href="<?php echo $this->config->item('site_url');?>hubungi_kami" title="Hubungi Kami | BitCom Online Jember"><li><img src="<?php echo base_url(); ?>asset/images/icon-contact.png" class="menu-img" border="0" />Hubungi Kami</li></a>

<a href="<?php echo $this->config->item('site_url');?>site_map" title="Site Map Website | BitCom Online Jember"><li><img src="<?php echo base_url(); ?>asset/images/icon-sitemap.png" class="menu-img" border="0" />Site Map Produk</li></a>

<a href="<?php echo $this->config->item('site_url');?>keranjang" title="Keranjang Belanja | BitCom Online Jember"><li><img src="<?php echo base_url(); ?>asset/images/icon-shopcart.png" class="menu-img" border="0" />Keranjang Belanja</li></a>
</ul>
</div>
